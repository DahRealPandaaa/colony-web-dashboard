...
public final class TextureHandler implements HttpHandler {
    ...
    public TextureHandler(TextureService textureService, AuthService auth) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        try {
            ...
            // "private": responses are behind a session cookie, so shared caches must not store them.
            exchange.getResponseHeaders().set("Cache-Control", "private, max-age=604800, stale-while-revalidate=86400");
