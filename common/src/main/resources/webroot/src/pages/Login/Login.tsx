  ...
  return (
    <div className="login-wrap">
      <div className="login-card">
        ...
        <h1 className="text-[22px] font-bold tracking-tight">Sign in with a pairing code</h1>
        ...
        <form className="mt-6" onSubmit={onSubmit}>
          ...
          <p className="text-[12.5px] text-rose-300 mt-2.5 min-h-[1.1rem]">{loginError}</p>
        ...
        <p className="text-[12.5px] text-slate-400 mt-6 leading-relaxed">
